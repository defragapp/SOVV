...
Use these terms exactly as written in all user-facing copy, documentation, onboarding, admin docs, product descriptions, and AI instructions.
...
| Invite Privately | Private invite flow |
| Public Preview | Shareable output (stripped of private data) |
| Watch Preview | Short visual scene output |
...
- "Covenant is an optional reflection space."
- "Both spaces share your Baseline Design and Library."

**Incorrect:**
- "Enter the DEFRAG Workbench."
- "Open Workspace."
- "Covenant is a separate product."
...
| Page | Title |
|---|---|
| Marketing pages | `[Page Name] — DEFRAG` (DEFRAG is acceptable in titles) |
