...
Internal guidance for consistent, safe, brand-protective positioning. This is not legal advice. Consult a qualified attorney for jurisdiction-specific legal questions.
...
Use these consistently in UI, marketing, support, and documentation:
...
The following claims must never appear in UI, marketing, support responses, social media, or any public-facing communication:
...
Users receive interpreted, human-usable output only. The engine behind the output is not disclosed.
...
## Recommended Legal Review Triggers

Seek qualified legal review before:
- Launching paid tiers publicly
- Expanding to new jurisdictions (especially EU/GDPR, California/CCPA)
- Adding features that process health-adjacent data
- Adding features that process data about minors
- Adding features that involve relationship or family legal contexts
- Responding to any legal demand, subpoena, or regulatory inquiry
- Making any public claim about accuracy, validation, or clinical standing