        ...
        <Container className="max-w-3xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {[
              ...
              { label: 'The platform', body: 'Your Baseline Design is the starting map. Defrag, Covenant, and Alignment are the spaces where the work happens. The Library is where you save what helped.' },
