...
export function UpgradeBanner() {
  return (
    <div className="w-full bg-gradient-to-r from-[#111111] to-[#0A0A0A] border border-white/[0.06] rounded-[10px] p-6 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.5)]">
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          <h3 className="text-[15px] font-medium text-[#f4efe9]">Sovereign.os Pro</h3>
