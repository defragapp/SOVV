    ...
    >
      <div className="flex items-end gap-3">
        ...
        <button
          ...
          className="shrink-0 border border-[#F6F5F3]/20 px-4 py-2 font-sans font-medium text-[9px] uppercase tracking-widest text-[#f4efe9] transition-colors hover:bg-[#F6F5F3]/5 disabled:opacity-25 disabled:cursor-not-allowed focus-visible:outline focus-visible:outline-1 focus-visible:outline-white/40"
        >
          Send
        </button>
      </div>
