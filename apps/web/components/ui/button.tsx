...
const variantClasses = {
  ...
  secondary: "bg-white/5 text-foreground border border-border hover:bg-white/10 hover:border-border-hover active:scale-[0.98] backdrop-blur-md rounded-xl",
  ghost: "bg-transparent text-foreground-muted hover:text-foreground hover:bg-white/5 border border-transparent rounded-lg",
  premium: "bg-white/5 text-foreground border border-border hover:bg-white/10 hover:border-border-hover active:scale-[0.98] backdrop-blur-md rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.05)]",
}
