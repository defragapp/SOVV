      ...
      >
        <div className="pointer-events-none z-10 flex max-w-3xl flex-col items-center px-6 text-center">
          ...
          <p className="mb-12 max-w-xl text-sm font-light leading-relaxed text-white/40 md:text-base">
            ...
            Identify the exact moment things derail. Take a clean step forward
            that doesn&apos;t trigger another fight.
          </p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-24">
        <div className="mb-24">
          ...
          <p className="text-2xl font-light leading-relaxed md:text-3xl">
            Most conflicts aren&apos;t about what you think they&apos;re about.
          </p>

          <div className="mt-8 space-y-6 text-lg leading-8 text-white/65">
            <p>
              The same argument keeps coming back because the underlying pattern
              never gets named. You react. They react. The loop continues.
            </p>

            <p>
              Sovereign shows you the structure beneath the surface — the trigger,
              the escalation point, the moment where a different move was possible.
            </p>

            <blockquote className="border-l border-white/20 pl-6 text-white/85">
              &ldquo;I could see exactly where I lost the thread — and what I could
              have said instead. That&apos;s never happened before.&rdquo;
            </blockquote>

            <p>
              This is clarity that lands. Not therapy. Not journaling. A map of
              what actually happened, and a move that breaks the cycle.
            </p>
          </div>
        </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
            <div>
              ...
              <h3 className="mb-2 text-lg">The Map</h3>
              <p className="text-sm leading-6 text-white/50">
                See the structure of the conflict without the emotional weight.
                What triggered it. What escalated it. What each person was
                actually defending.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="mb-2 text-lg">The Shift</h3>
              <p className="text-sm leading-6 text-white/50">
                Identify the exact moment the conversation derailed — and what
                a different response would have looked like in that moment.
              </p>
            </div>

            <div>
              <span className="mb-4 block text-2xl">3.</span>
              <h3 className="mb-2 text-lg">The Move</h3>
              <p className="text-sm leading-6 text-white/50">
                Take a clean step forward that doesn&apos;t trigger another fight.
                Concrete. Specific. Yours to own.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-24">
          ...
          <ul className="space-y-4 text-lg font-light text-white/80">
            {[
              "Recurring arguments with a partner or co-parent",
              "Workplace conflicts that keep resurfacing",
              "Family dynamics you can't seem to change",
              "Any conversation you've been dreading",
            ].map((feature) => (
        ...
        <div className="border-t border-[#F6F5F3]/10 py-24 text-center">
          ...
          <p className="mb-8 text-white/40 text-sm">
            No jargon. No stigma. Just a clear map and a clean move.
          </p>
