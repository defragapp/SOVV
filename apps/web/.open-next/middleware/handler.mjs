...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let bt = /* @__PURE__ */ new Set(["defrag.app", "www.defrag.app", "sovereign.defrag.app"]), bu = /* @__PURE__ */ new Set(["app.defrag.app"]), bv = /\.(.*)$/;
      function bw(a10) {
        let b2 = a10.headers.get("host")?.toLowerCase() ?? "", c2 = a10.nextUrl.clone(), d2 = c2.pathname;
        return d2.startsWith("/_next") || d2.startsWith("/api") || d2.startsWith("/assets") || "/favicon.ico" === d2 || "/robots.txt" === d2 || "/sitemap.xml" === d2 || d2.includes(".") || bv.test(d2) || bt.has(b2) ? S.next() : bu.has(b2) && "/" === d2 ? (c2.pathname = "/app", S.rewrite(c2)) : (d2.startsWith("/workspace") || d2.startsWith("/app")) && !(a10.cookies.get("sb-access-token")?.value || a10.cookies.get("supabase-auth-token")?.value || a10.cookies.get("__session")?.value) ? (c2.pathname = "/app/login", S.redirect(c2)) : d2.startsWith("/settings") ? S.redirect(new URL(`https://app.defrag.app${d2}`)) : S.next();
      }
      let bx = { matcher: ["/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml).*)"] };
...
var init_edgeFunctionHandler = __esm({
  "../../node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|robots.txt|sitemap.xml).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
