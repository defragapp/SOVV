  ...
  return (
    <div className="flex h-[100dvh] w-screen overflow-hidden bg-[#08070a] text-[#f4efe9]">
      <div className="hidden w-[260px] flex-col border-r border-white/[0.05] lg:flex">
        <PanelHeader label="Signal context" />
      ...
      <div className="flex flex-1 flex-col">
        <PanelHeader label="Alignment" detail="Preparing the workspace" />
        <PremiumLoadingState
          label="Opening Alignment"
          body="Sovereign is preparing the relational field before the workspace appears."
        />
      </div>

      <div className="hidden w-[300px] flex-col border-l border-white/[0.05] lg:flex">
        <PanelHeader label="Saved outputs" />
