...
export default function DefragPage() {
    ...
    <div className="flex flex-col h-full justify-end gap-8">
      <div className="flex-1 flex flex-col items-center justify-center text-center gap-5 max-w-sm mx-auto opacity-50">
        ...
        <div className="gap-2 flex flex-col">
          <h2 className="text-base font-medium text-[#FAFAFA] tracking-tight">What is happening right now?</h2>
          <p className="text-xs text-[#52525B] font-mono leading-relaxed">
            Paste a message, describe a conflict,<br />or share a repeating dynamic.
          </p>
        </div>
      </div>
  ...
  const mainResultArea = (
    <div className="border border-white/[0.06] bg-[#080808] p-6">
      <p className="text-[10px] font-mono text-[#3F3F46] uppercase tracking-[0.2em] mb-3">Structured Output</p>
      <p className="text-xs text-[#52525B] font-mono">Results will appear here after running Defrag.</p>
    </div>
  )
