  ...
  return (
    <main className="min-h-screen bg-surface text-[#f4efe9] flex flex-col items-center selection:bg-white/10 selection:text-white pt-24 pb-16 px-6">
      <div className="w-full max-w-2xl flex flex-col gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.05] border border-border">
          <div className="bg-surface p-10 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              <a href="https://app.defrag.app/login" className="flex items-center justify-center w-full border border-border bg-white text-black hover:bg-white/90 transition-colors h-10 text-[10px] font-mono uppercase tracking-[0.14em]">
                Sign In
              </a>
              <a href="/about" className="flex items-center justify-center w-full border border-border bg-transparent text-[#a8a29a] hover:text-[#f4efe9] hover:border-border transition-colors h-10 text-[10px] font-mono uppercase tracking-[0.14em]">
                About
              </a>
              <a href="/faq" className="flex items-center justify-center w-full border border-border bg-transparent text-[#a8a29a] hover:text-[#f4efe9] hover:border-border transition-colors h-10 text-[10px] font-mono uppercase tracking-[0.14em]">
                FAQ
              </a>
            </div>
          </div>
        ...
        <footer className="pt-8 border-t border-border flex items-center justify-between text-[10px] font-mono text-[#4f4b47] uppercase tracking-widest">
