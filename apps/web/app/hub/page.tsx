        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.05] border border-white/[0.06]">
          <div className="bg-[#0c0a0d] p-10 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              <a href="/app/login" className="flex items-center justify-center w-full border border-border bg-white text-black hover:bg-white/90 transition-colors h-10 text-[10px] font-sans font-medium uppercase tracking-[0.15em]">
                Sign In
              </a>
