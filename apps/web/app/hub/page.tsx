        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.05] border border-border">
          <div className="bg-surface p-10 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              <a href="https://app.defrag.app/app/login" className="flex items-center justify-center w-full border border-border bg-white text-black hover:bg-white/90 transition-colors h-10 text-[10px] font-sans font-medium uppercase tracking-[0.15em]">
                Sign In
              </a>
          ...
          <div className="bg-surface p-10 flex flex-col gap-8 border-l border-border">
            ...
            <div className="space-y-4">
              <a href="/apps/defrag" className="block border border-border bg-transparent p-4 hover:border-border transition-colors group">
              ...
              <a href="/apps/covenant" className="block border border-border bg-transparent p-4 hover:border-border transition-colors group">
