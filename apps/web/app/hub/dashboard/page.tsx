  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-background text-white p-8 flex items-center justify-center">
        <div className="font-sans font-medium">AUTHENTICATING...</div>
      </main>
    )
  }
    ...
    <main className="min-h-screen bg-background text-white p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="border border-border p-4">
          ...
          <button className="mt-4 w-full border border-border p-2 hover:bg-white hover:text-black">
            VIEW
          </button>
        </div>
        <div className="border border-border p-4">
          ...
          <a href="/members" className="mt-4 block w-full text-center border border-border p-2 hover:bg-white hover:text-black">
            MANAGE
          </a>
        </div>
        <div className="border border-border p-4">
          ...
          <a href="/billing" className="mt-4 block w-full text-center border border-border p-2 hover:bg-white hover:text-black">
            VIEW
          </a>
        </div>
      </div>
