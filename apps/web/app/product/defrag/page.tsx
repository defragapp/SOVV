    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      <AnimatePresence mode="wait">
        {revealed && (
          ...
          >
            {[
              { label: "What’s active", value: current.result.pattern, highlight: false },
              { label: "What repeats", value: current.result.repeat, highlight: false },
              { label: "Pattern under it", value: current.result.mode, highlight: false },
