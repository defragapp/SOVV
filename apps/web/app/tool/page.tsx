    ...
    <main className="min-h-screen bg-surface text-[#f4efe9] flex flex-col items-center justify-center p-8 selection:bg-white/10 selection:text-white">
      <div className="w-full max-w-sm border border-border bg-surface p-10 flex flex-col gap-10">
        ...
        <section className="space-y-4">
          ...
          <a href="/apps/defrag" className="flex items-center justify-center w-full border border-border bg-transparent text-[#a8a29a] hover:text-white hover:border-border transition-colors h-10 text-[10px] font-sans font-medium uppercase tracking-[0.15em]">
            Defrag Space
          </a>
          <a href="/apps/covenant" className="flex items-center justify-center w-full border border-border bg-transparent text-[#a8a29a] hover:text-white hover:border-border transition-colors h-10 text-[10px] font-sans font-medium uppercase tracking-[0.15em]">
            Covenant Space
          </a>
        </section>
